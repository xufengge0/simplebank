...
// ListEntrys mocks base method.
func (m *MockStore) ListEntrys(arg0 context.Context, arg1 db.ListEntrysParams) ([]db.Entry, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListEntrys", arg0, arg1)
	ret0, _ := ret[0].([]db.Entry)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListEntrys indicates an expected call of ListEntrys.
func (mr *MockStoreMockRecorder) ListEntrys(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListEntrys", reflect.TypeOf((*MockStore)(nil).ListEntrys), arg0, arg1)
}
